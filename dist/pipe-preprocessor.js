function createIDEFriendlyPipePreprocessor(options = {}) {
    const { pipePrefix = '', pipeRegistry = null, debug = false, generateDTS = true, ideMode = process.env.NODE_ENV === 'development', suppressIDEWarnings = true } = options;
    return {
...
export { createIDEFriendlyPipePreprocessor };
//# sourceMappingURL=pipe-preprocessor.js.map
